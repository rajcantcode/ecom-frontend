                  ...
                  <div className="hidden md:block">
                    <div className="flex items-center ml-4 md:ml-6">
                      ...
                      {numberOfItemsInCart > 0 && (
                        <span className="z-10 inline-flex items-center px-1.5 py-0.5 mb-6 -ml-3 text-xs font-medium text-green-700 rounded-md bg-green-50 ring-1 ring-inset ring-green-600/20">
                          {numberOfItemsInCart}
                        </span>
                      )}
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-gray-700">
                  <div className="flex items-center px-5">
                    ...
                    {numberOfItemsInCart > 0 && (
                      <span className="z-10 inline-flex items-center px-1.5 py-0.5 mb-6 -ml-4 text-xs font-medium text-green-700 rounded-md bg-green-50 ring-1 ring-inset ring-green-600/20">
                        {numberOfItemsInCart}
                      </span>
                    )}
                  </div>
